...
### CDN (메인)
```html
<script type="module" src="https://autotheme-js.dxdxffg.com/dist/AutoTheme.mjs">// 압축된 상태</script>
<script type="module" src="https://autotheme-js.dxdxffg.com/AutoTheme.js">// 원본</script>
```
